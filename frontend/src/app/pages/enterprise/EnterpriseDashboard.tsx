                    ...
                    <div className="flex items-center justify-end pt-2 border-t border-gray-100 text-xs text-gray-400">
                      <div className="flex items-center gap-3">
                        ...
                        <button
                          ...
                          className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-rose-50 hover:bg-rose-500 text-rose-500 hover:text-white border border-rose-200 hover:border-rose-500 transition-all cursor-pointer font-semibold"
                          title="Delete post"
                        >
